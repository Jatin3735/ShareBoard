...
function CreateNote() {
  const [noteType, setNoteType] = useState('text'); // 'text', 'audio', or 'image'
              ...
              {noteType === 'text' && (
                ...
                >
                  <textarea
                    ...
                    maxLength="5000"
                    rows="8"
                    className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-white resize-none"
                  />
                  ...
                  <motion.button
                    ...
                    className="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg font-semibold text-white disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {uploading ? (
              ...
              {noteType === 'audio' && (
                ...
                >
                  <motion.div
                    ...
                    className="mb-8"
                  >
                    <div className={`w-48 h-48 mx-auto rounded-full flex items-center justify-center shadow-2xl ${
                      isRecording 
                ...
                >
                  {!imagePreview ? (
                    <div
                      ...
                      className="border-2 border-dashed border-white/30 rounded-lg p-12 text-center cursor-pointer hover:border-white/50 transition-all"
                    >
                      <Upload className="w-16 h-16 text-white/50 mx-auto mb-4" />
                      <p className="text-white/70 mb-2">Click to upload an image</p>
                      <p className="text-white/40 text-sm">JPG, PNG, GIF up to 5MB</p>
                      <input
                        ref={fileInputRef}
                        type="file"
                        accept="image/*"
                    ...
                    <div className="space-y-4">
                      <div className="relative">
                        <img
                          src={imagePreview}
                          alt="Preview"
                          className="w-full rounded-lg max-h-96 object-contain bg-white/10"
                        />
                        <button
                          onClick={removeImage}
                      ...
                      <motion.button
                        ...
                        onClick={uploadImage}
                        disabled={uploading}
                        className="w-full py-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg font-semibold text-white disabled:opacity-50"
                      >
                        {uploading ? (
                          <span className="flex items-center justify-center gap-2">
                            <Loader className="w-5 h-5 animate-spin" />
