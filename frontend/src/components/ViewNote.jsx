...
function ViewNote() {
  ...
  const fetchNote = async () => {
    ...
    try {
      // First, check the note info to know the type
      ...
      if (infoResponse.data.exists) {
        ...
        if (infoResponse.data.type === 'text') {
          ...
          // For image, create the image URL
          const imageUrl = `${API_URL}/audio/${code}`;
          setImageUrl(imageUrl);
          
          // Also fetch info for view count
          setNoteData({
  ...
  const downloadImage = async () => {
    if (imageUrl) {
      try {
        ...
        link.href = url;
        link.setAttribute('download', `audioboard-${code}.jpg`);
            ...
            >
              <div className="bg-white/20 rounded-lg p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-white font-semibold">Text Message</span>
                </div>
              ...
              <div className="bg-white/20 rounded-lg p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <motion.button
                    ...
                    className="px-3 py-1 bg-white/20 rounded-lg text-white text-sm flex items-center gap-1 hover:bg-white/30"
                  >
                    <Download className="w-4 h-4" />
                    Download
                  </motion.button>
                </div>
                <div className="bg-white/10 rounded-lg p-4 flex justify-center">
                  <img
                    src={imageUrl}
                    alt="Shared content"
            ...
            >
              <div className="bg-white/20 rounded-lg p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-white font-semibold">Audio Message</span>
                </div>
